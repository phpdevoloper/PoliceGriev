...
header("Content-Security-Policy: object-src 'self'; script-src 'self' 'nonce-1a2b'", TRUE);
...
<div>
	<div align="center" style="margin-top:25px;">
    	...
    	<span style="font-weight:bold;font-size:23px;color: rgb(0,0,225);">Welcome to Police Station Complaint Redressal System of Tamil Nadu Police</span>
		<?php } else { ?>
