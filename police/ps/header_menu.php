...
header("Content-Security-Policy: object-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'", TRUE);
ob_start();
//if(session_id() == '')
	//{
    //session_start();
...
<head>
    ...
    <title><?php if(isset($pagetitle) == ""){ echo "PS"; } else { echo $pagetitle; } ?></title>
...
<div><?php include("ticker.php"); ?> </div>
	...
	<div class="T_E">
		...
		<div class="T_E_C_P" style="width:max-content;">
		 <?php
		if($_SESSION["lang"]=='T')
		{
		...
		?>
			Police Station Complaint Redressal System
        <?php } ?>
		</div>
	</div>
	<div class="T_E_U">	
