...
source='P';
	window.location.href="http://14.139.183.34/police/ps/pm_petition_doc_download.php?doc_id="+url+"&source="+source;
}
	...
	<thead>
		<tr id='btn_row' >
			<td colspan="7" class="text-center pad_t" >
			 <a class="btn btn-primary fa fa-print"  name="print" id="print" onClick="return print_page();">&nbsp;<?PHP echo $lang['Print_Button_Label']; //View ?></a> 
			 <a class="btn btn-primary fa fa-sign-out"  name="back" id="back" onClick="goback();">&nbsp;<?PHP echo $lang['Back_Button_Label']; //View ?></a>
			</td>
		</tr>
