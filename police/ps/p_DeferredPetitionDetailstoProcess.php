...
<!--    	<img src="images/download.png" onclick="download_document(<?php //echo $key['doc_id']; ?>)"/>-->
	...
	function download_document(url,src){
		//window.location.href="http://locahost/police/ps/pm_petition_doc_download.php?doc_id="+url+"&source="+src;
		window.location.href="http://localhost/police/ps/pm_petition_doc_download.php?doc_id="+url+"&source="+src;
	}
				</script>
        </td>
    </tr>  
