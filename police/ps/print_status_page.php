...
function download_document(url,source){
	//window.location.href="http://locahost/police/ps/pm_petition_doc_download.php?doc_id="+url+"&source="+source;
	//window.location.href="http://localhost/police/ps/pm_petition_doc_download.php?doc_id="+url+"&source="+source;
