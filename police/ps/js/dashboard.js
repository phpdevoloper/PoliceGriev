	...
	var myChart6 = new Chart(ctx6, {
	    ...
	    data: {
	        ...
	        datasets: [{
	            ...
	            data: [120000, 170000, 190000, 280000, 320000, 690000, 810000, 1040000, 1323000],
	            backgroundColor: 'rgba(54,162,235, 1)',
	            borderColor: 'rgba(54,162,235, 1)',
	            borderWidth: 2,
	            fill: false
	    ...
	    options: {
	        scales: {
	            yAxes: [{
	            	scaleLabel: {
						display: true,
						labelString: 'Earnings (in Rupees)'
					},
	                ticks: {
	                    beginAtZero: true
	                }
...
if(ctx22) {
	var myChart22 = new Chart(ctx22, {
	    type: 'doughnut',
	    data: {
	        labels: ['Direct', 'Advertisement', 'Social'],
	        datasets: [{
