	...
	<div class="container common-container">
    	<div class="common-left common-left-ind clearfix">
          <ul>
			...
			<a href="javascript:void(0);" title="Increase font size" id="a" onClick="changeFontSize('content','2');"><span >A<sup>+</sup></span></a>
			</li>
			<li class="ministry" id="ministry3">
			<a href="javascript:void(0);" title="Reset font size" onClick="resetFontSize('content');resetFontSizet('content');" id="a_p"><span>A<sup>&nbsp;</sup></span></a>
			</li>
			<li class="ministry" id="ministry4">
			<a href="javascript:void(0);" title="Decrease font size" onClick="changeFontSize1('content','-2');" id="a_m"><span>A<sup>-</sup></span></a>
			</li>
			<li class="ministry min_bor" id="ministry5">
			<a title="Change Colour Contrast"  href="javascript:void(0);" onClick="set_all_colour();" id="a_c"><span>A</span></a>
			</li>
          </ul>
        </div>
    </div>
...
<div>
	...
	<div class="scroo_3 " >
	<marquee  id="marq123" style="font-size:15px;" onmouseover="this.stop();" onmouseout="this.start();"><?php echo $lang['SM_MSG1'];?></marquee>
	</div>

	<div class="scroo_4">
	<p class="scroo_2_m note_home scroo_2_m11" style="background-color: white;color: #e1297f;width: 8vw;" onclick="openNav()"><img src="theme/images/icon_gallery.png" class="gallery_img" ><!--span class="glyphicon glyphicon-align-justify" style="margin-left: 12px;"></span --> <?php echo $lang['MORE'];?> </p>
	
	</div>
	
	<div style="clear:both;"></div>
	<div id="mySidenav" class="sidenav" >
  <a id="sn1" href="javascript:void(0)" class="closebtn" onclick="closeNav()">x</a>
...
<section class="wrapper-container banner-wrapper" id="happay_hiden" >
	...
	<div class="required-field-block animated bounceInRight centerthing " onmouseover = "show0()" onmouseout="show_out0(this)"  data-toggle="modal" data-target="#offical">
			<!--div class="position_a3 ma_log " id="m1" >Officials Login</div-->
			<img src="<?php echo $lang['off_log_img'];?>"  id="loginme1" alt="Grievanceimg" rel="noopener" title="Click here to Login ..."  draggable="false" style="height:6vh;width:18vw;overflow:visible;position:relative;z-index: 201;" >
			</div>
...
<!--<div class="container" >
		...
		<div class="required-field-block animated bounceInRight"  onmouseover = "show2()" onmouseout="show_out2(this)" data-toggle="modal" data-target="#nri"><a href="https://locahost/police/ps/nri/">
...
<div class="all_footer" id="he_colour3">
	<div class="nic_link">
		<p id="v27" onmouseover ="team()" onmouseout="team_condition(this)"><?php echo $lang['TEAMS_CONDITION']; ?></p>
	</div>
	<div class="nic_link1">
		<p id="v26" onmouseover = "HYPERLINK_POLICY1()" onmouseout="HYPERLINK_POLICY2(this)" ><?php echo $lang['HYPERLINK_POLICY']; ?></p>
	</div>
	<div class="nic_cen">
	<p id="v25" onmouseover = "copy_policy()" onmouseout="copy_policy1(this)" ><?php echo $lang['COPYRIGHT_POLICY']; ?></p>
	</div>
	
	<div class="nic_cen1">
	<p id="v24" onmouseover = "privacy()" onmouseout="privacy1(this)" ><?php echo $lang['PRIVACY_POLICY']; ?></p>
	</div>
	<div class="link">
		<div class="txt_r">
           <p id="v23" onmouseover = "Disclamier1()" onmouseout="Disclamier2(this)"><?php echo $lang['DISCLAMIER']; ?></p>
		</div>
	</div>
	<div class="link">
		<div class="txt_r">
           <a target="_blank" target="_blank" style="text-decoration: none;" rel="noopener" href="https://servicedesk.nic.in/" title="Click here to visit - servicedesk.nic.in"> <p id="v35" onmouseover = "service1()" onmouseout="service2(this)"><?php echo $lang['SERVICE_DESK']; ?></p></a>
		</div>
	</div>
</div>

<div class="all_footer" id="he_colour3_gallery" style="display: none;">
	<div class="nic_link">
		<span id="v29" onmouseover = "team1()"  onmouseout="team_condition1(this)"><?php echo $lang['TEAMS_CONDITION']; ?></span>
		
	</div>
	<div class="nic_link1">
		<a><p id="v30" class="hoe" onmouseover = "HYPERLINK_POLICY3()" onmouseout="HYPERLINK_POLICY4(this)"><?php echo $lang['HYPERLINK_POLICY']; ?></p>
	</div>
	<div class="nic_cen">
	<p id="v31" onmouseover = "copy_policy2()" onmouseout="copy_policy3(this)"><lim1><?php echo $lang['COPYRIGHT_POLICY']; ?></p>
	</div>
	
	<div class="nic_cen1">
	<p id="v32" onmouseover = "privacy2()" onmouseout="privacy3(this)"><?php echo $lang['PRIVACY_POLICY']; ?></p>
	</div>
	<div class="link">
		<div class="txt_r">
           <p id="v33" onmouseover = "Disclamier3()" onmouseout="Disclamier4(this)"><?php echo $lang['DISCLAMIER']; ?></p>
		</div>
	</div>
		<div class="link">
		<div class="txt_r">
           <a target="_blank" target="_blank" style="text-decoration: none;" rel="noopener" href="https://servicedesk.nic.in/" title="Click here to visit - servicedesk.nic.in"> <p id="v36" onmouseover = "service_desk1()" onmouseout="service_desk2(this)"><?php echo $lang['SERVICE_DESK']; ?></p></a>
		</div>
	</div>
	<!--div class="link">
		<div class="txt_r">
          <a target="_blank" target="_blank" style="text-decoration: none;" rel="noopener" href="https://servicedesk.nic.in/" title="Click here to visit - servicedesk.nic.in"> <p id="v24" onmouseover = "service3()" onmouseout="service4()"><?php echo $lang['SERVICE_DESK']; ?></p></a>
		</div>
	</div-->
</div>
 ...
 <div class="modal fade" id="offical" role="dialog" data-backdrop="static" data-keyboard="false" >
      ...
      <div class="modal-content ba_co3">
       ...
       <div class="modal-body note_col">
		<div class="required-field-block">
         <input type="text" id="username" class="login_val" name="username" title="User Id" placeholder="<?php echo $lang['USER_ID_TITLE']; ?>" maxlength="30"  onchange="username_chk();" autocomplete="off" autofocus / >
	...
	<div class="modal-body note_col">
	  <div class="required-field-block txt_wid">
         <input type="text" class="login_val1" id="security_code_offical" name="security_code_offical" title="Enter Security Code"  placeholder="<?php echo $lang['SECURITY_CODE_TITLE']; ?>" maxlength="6" onKeyPress="return buttonsubmit3(event)"   autocomplete="off"  / >
		 <div class="required-icon rg_zero1"> <div class="text">*</div> </div>
	  </div>
	 
	  <div class="txt_wid1">
	  <a HREF="javascript:reloadCaptcha_off()"><img src="theme/images/reload.png" class="re_img" alt ="reload" rel="noopener" title="Clik to Reload"></a>
	  </div>
	  <div class="txt_wid2">
	  <img src="captcha_off.php?width=70&height=30&characters=5&rs=<?php echo  $ResultStr_off; ?>" class="bt_se" id="captcha_off"  alt ="captcha" > 
	  <input type="hidden" name="capchaval1" id="capchaval" value="<?php echo substr($_SESSION['key'],0,5); ?>" />
        ...
        <div class="modal-footer">
         <button type="button" class="reg_btn" id="sub_mit" title="Click here to Submit" onclick="return validateFormofficals('<?php echo $_SESSION['salt'];?>','<?php echo $_SESSION['itno'];?>','<?php echo $_SESSION['itno'];?>');"><?php echo $lang['SUBMIT_BUTTON_TITLE']; ?></button>
		  <button type="button" class="reg_btn fn_cl" id="reset" title="Click here to Reset" onClick="return v_reset_officals();" ><?php echo $lang['RESET_BUTTION_TITLE']; ?></button>
        </div>
   ...
   <!--input type="hidden" name="lang" value="E" /-->
    ...
    <div class="modal-dialog modal-sm check_pet reg_box2">
      <div class="modal-content ba_co1">
       ...
       <div class="modal-body note_col">
		<div class="required-field-block">
         <input type="text" id="petition_no" onblur="killChars(this);" class="login_val" name="petition_no" title="Enter Petition Number" placeholder="<?php echo $lang['PETITION_NO_TITLE']; ?>" maxlength="30"  autocomplete="off" autofocus / >
		 <div class="required-icon"> <div class="text">*</div> </div>
		</div>
       </div>
	  <div style= "margin-top: -20px;"></div> 
	...
	<div class="modal-body note_col">
	  <div class="required-field-block txt_wid">
         <input type="text" class="login_val1" id="security_code" name="security_code" title="Enter Security Code"  placeholder="<?php echo $lang['SECURITY_CODE_TITLE']; ?>" maxlength="6" onblur="checkValue()"  autocomplete="off" onKeyPress="return buttonsubmit1(event)"/ >
		 <div class="required-icon rg_zero1"> <div class="text">*</div> </div>
	  </div>
	 
	  <div class="txt_wid1">
	  <a HREF="javascript:reloadCaptcha()"><img src="theme/images/reload.png" class="re_img" rel="noopener" alt ="reload" title="Clik to Reload"></a>
	  </div>
	  <div class="txt_wid2">
	  <img src="captcha.php?width=70&height=30&characters=5&rs=<?php echo  $ResultStr; ?>" class="bt_se" id="captcha"  alt ="captcha" > 
 ...
 <!-- Modal POPUP Start Online-->
    ...
    <div class="modal-dialog modal-sm check_pet reg_box2">
      <div class="modal-content ba_co2">
       ...
       <div class="modal-body note_col">
		<div class="required-field-block">
         <input type="text" id="mobilenumber" class="login_val" name="mobilenumber"  title="Enter Mobile Number" placeholder="<?php echo $lang['MOBILE_NO_TITLE']; ?>" maxlength="10"  onchange="mob_chk();" onKeyPress="return numbersonly_ph(event);"  autocomplete="off" autofocus / >
		 <div class="required-icon"> <div class="text">*</div> </div>
		</div>
       </div>
	  <div style= "margin-top: -20px;"></div> 
	...
	<div class="modal-body note_col">
	  ...
	  <div class="txt_wid2">
	  <img src="captcha_online.php?width=70&height=30&characters=5&rs=<?php echo  $ResultStr; ?>" class="bt_se" id="captcha_online"  alt ="captcha" > 
  <input type="hidden" name="capchaval2" id="capchaval2" value="<?php echo $ResultStr; ?>" />
	  ...
	  <div class="required-field-block txt_wid">
		...
		<input type="password" class="login_val1"onblur="killChars(this);" id="otp" name="otp" maxlength="6" title="Enter OTP" placeholder="<?php echo $lang['OTP_TITLE']; ?>" 
			onKeyPress="return buttonsubmit2(event);  "  
			onKeyUp="return numbersonly_ph1(event);" autocomplete="off" autofocus >	
	...
	<div class="ge_otp_wi">
		  <button type="button" class="ge_otp " id="generate_otp" onclick="checkAndSaveMobile();" title="Click here to Generate OTP"><?php echo $lang['SEND_OTP_BUTTON_TITLE']; ?></button>
		   <button type="button" class="ge_otp " id="resend_otp" style="display:none;" onclick="resendOtp();" title="Click here to Resend OTP"><?php echo $lang['RESEND_OTP_BUTTON_TITLE']; ?></button>
		 </div>
	  </div>
	...
	<div class="footer1" >
	 ...
	 <font></font>&nbsp 
        ...
        <div class="modal-footer">
         <button type="button" class="reg_btn" id="sub_mit2" title="Click here to Submit" onClick="return validateForm();"><?php echo $lang['SIGNIN_BUTTON_TITLE']; ?></button>
		  <button type="button" class="reg_btn fn_cl" id="reset" title="Click here to Reset" onClick="return v_reset_online();" ><?php echo $lang['RESET_BUTTION_TITLE']; ?></button>
        </div>
...
?>
<div align="center" >
<span style="color:#A94442;"><script>alert('<?php echo $_SESSION['error_msg1']; ?>');</script></span>
</div>
<?php
