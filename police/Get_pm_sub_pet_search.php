...
<title>Applicant Details & Location based Search</title>
<style>
.stop-scrolling {
  height: 100%;
  overflow: hidden;
...
<table class="existRecTbl" style="border-top-style: solid;">
	<thead>
    <tr>
    	<th style="background-color: #BC7676; color: #FFFFFF; font-size: 150%;" colspan="2">Applicant Details & Location based Search</th>
    </tr>
	</thead>
</table>
