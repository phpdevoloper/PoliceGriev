...
<div class="contentMainDiv" style="width:98%;margin:auto;">
	<div class="contentDiv">	
		<table class="rptTbl">
            ...
            <tr> 
				<th colspan="8" class="main_heading"><?PHP echo $label_name[33].' - Action Taken by me and Rejected' //Forwarded by me and pending with others'; //Department wise Report?></th>
			</tr>
	...
	$dist_cond=$userProfile->getOff_level_id()==1 ? "mst_p_district" : "fn_single_district(".$userProfile->getDistrict_id().")"; // fn_single_district
		...
		".$cond3.$src_condition.$grev_condition.$grev_dept_condition.$petition_type_condition.$pet_community_condition.$special_category_condition." and  b.l_action_type_code='R')) order by griev_type_id, griev_subtype_id";
		//echo $sql;
	    $result = $db->query($sql);
