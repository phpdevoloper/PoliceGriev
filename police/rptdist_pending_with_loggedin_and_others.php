...
{ 
	...
	document.rpt_abstract.action="rptdist_pending_with_loggedin_and_others.php";
...
<div class="contentMainDiv" style="width:98%;margin:auto;">
	<div class="contentDiv">	
		<table class="rptTbl">
            ...
            <tr> 
				<th colspan="12" class="main_heading"><?PHP echo $label_name[33].' - '.$label_name[34]  //Originally forwarded to me and Pending with myself or others ?></th>
			</tr>
...
//				$off_condition = " and a1.off_level_id in (2,3,4,5,6,7,10,11)";				
	...
	$dist_cond=$userProfile->getOff_level_id()==1 ? "mst_p_district" : "fn_single_district(".$userProfile->getDistrict_id().")"; // fn_single_district
		...
		where (a1.l_to_whom =  ".$userProfile->getDept_user_id()." or  (a1.l_action_entby=".$userProfile->getDept_user_id()." and a1.l_action_type_code='T')) and ".$cond3.$src_condition.$grev_condition.$grev_dept_condition.$petition_type_condition.$pet_community_condition.$special_category_condition." ) 
	...
	<div class="contentDiv">	
		<table class="rptTbl">
			<thead>
				...
				<tr> 
				<th colspan="8" class="main_heading"><?PHP echo $label_name[33].' - '.$label_name[34]  //Originally forwarded to me and Pending with myself or others ?><?php echo " ".$cnt_type; ?></th>
                </tr>
                 <?php if($reporttypename!="") { ?>
                <tr>
...
$i=1;
	...
	if($status=='rwp'){
		...
		where --a1.f_to_whom =  ".$userProfile->getDept_user_id()." 
		(a1.l_to_whom =  ".$userProfile->getDept_user_id()." or  (a1.l_action_entby=".$userProfile->getDept_user_id()." and a1.l_action_type_code='T')) and ".$cond3.$src_condition.$grev_condition.$grev_dept_condition.$petition_type_condition.$pet_community_condition.$special_category_condition." )
