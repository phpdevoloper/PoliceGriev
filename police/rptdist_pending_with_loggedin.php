...
{ 
	...
	document.rpt_abstract.action="rptdist_pending_with_loggedin.php";
...
<div class="contentMainDiv" style="width:98%;margin:auto;">
	<div class="contentDiv">	
		<table class="rptTbl">
            ...
            <tr> 
				<th colspan="12" class="main_heading"><?PHP echo $label_name[33].' - '.$label_name[35] //Pending with myself at present '; //Department wise Report?></th>
			</tr>
	...
	$dist_cond=$userProfile->getOff_level_id()==1 ? "mst_p_district" : "fn_single_district(".$userProfile->getDistrict_id().")"; // fn_single_district
		...
		where (a1.l_to_whom =  ".$userProfile->getDept_user_id().") and ".$cond3.$src_condition.$grev_condition.$grev_dept_condition.$petition_type_condition.$pet_community_condition.$special_category_condition." ) 
	...
	<div class="contentDiv">	
		<table class="rptTbl">
			<thead>
				...
				<tr> 
				<th colspan="8" class="main_heading"><?PHP echo $label_name[33].' - '.$label_name[35] ;?> <?php echo " ".$cnt_type; ?></th>
                </tr>
                <?php if($reporttypename!="") { ?>
                <tr>
