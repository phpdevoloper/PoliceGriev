...
ob_start();
session_start();
$pagetitle="Link Petition With External Documents";
include("db.php"); 
...
function openPetitionStatusReport(petition_id){
	...
	document.petiton_status_report.action = "p_PetitionLinkExternalDetails.php";
...
function p_clearSerachParams(){
	...
	document.petiton_status_report.action = "Petition_Link_External_Search_Form.php";
	document.petiton_status_report.method="post";
...
function p_loadGrid(pageNo, pageSize){
	...
	var param = "mode=p_search_for_link"
		+"&page_size="+pageSize
		+"&page_no="+pageNo
...
<form name="petiton_status_report" id="petiton_status_report" enctype="multipart/form-data" method="post" action="" style="background-color:#F4CBCB;">
  <div id="dontprint">
    <div class="form_heading">
       <div class="heading"><?php echo 'Link Petition External'; //Petition Re-open?> </div>
    </div>
  </div>
...
<td class="fldTD" colSpan="3"><select name="p_source" id="p_source">
          ...
          <tr>  
            ...
            <td class="fldTD" colSpan="3"><select name="p_griev_sub_type" id="p_griev_sub_type" onchange="getDepts();">
