...
$ResultStr_off = substr($RandomStr,0,5);//trim 5 digit 
...
imagestring($NewImage, 70, 15, 5, $ResultStr_off, $TextColor);// Draw a random string horizontally 

$_SESSION['key'] = $ResultStr_off;// carry the data through session
