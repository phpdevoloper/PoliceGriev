...
<div class="My_pet_1x">
	<div class="My_pet_1_k "><br><br>
		<div class="My_pet_2x" style="background: #95342e;">
			<label style=" color: #ffffff;"><?php echo $lang['Acknowledgement_LABEL_menu_hea']; ?><label>
		</div><br>
...
<div class="My_pet_1">
	<div class="My_pet_1_k">
		<div class="My_pet_2"  style="text-align: right;">
			<label><?php echo $lang['petition_Acknowledgement']; ?><label>
		</div>
		<div class="My_pet_3">
		  ...
		  $.ajax({
			...
			success: function(html){
				...
				if(str != 0){
				 ...
				 document.view_status.action = "online_print_acknowledment.php"
