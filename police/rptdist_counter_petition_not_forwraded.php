...
//echo ">>>>>>>>>>>>>>>>>>>>>>>>";
	...
	if ($rep_src == 'simple') {
		...
		$simple_condition = " action_entby=".$userProfile->getDept_user_id(); 
	}
	...
	WHERE ".$simple_condition." and a.action_type_code='T' and a.l_action_type_code='T'";
...
<div class="contentMainDiv" style="width:98%;margin:auto;">
	...
	<tr><th colspan="14" class="sub_heading"><?php echo $userProfile->getDept_desig_name().' - '.$userProfile->getOff_loc_name();?></th></tr>
	<?php } ?>
    <tr><th colspan="14" class="main_heading"> Yet to be Forwarded &nbsp;&nbsp;&nbsp;(No of Petitions : <?php echo $petcount;?> ) </th></tr>
