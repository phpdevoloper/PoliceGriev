...
if ($ippart[1] == 'pm_upload_order_cert.php'){
	$url = 'https://locahost/police/pm_upload_order_cert_action.php';
}
else {
	$url = 'https://locahost/police/psppp/pm_upload_order_cert_action.php';
}
$url = 'http://localhost/police/pm_upload_order_cert_action.php';
$ch = curl_init();
