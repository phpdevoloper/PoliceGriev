...
if($_SESSION['lang']=='E'||$_SESSION['lang']=='T'){
	$_SESSION['lang']='E';
}
        ...
        <div class="header-right call_now_head clearfix home_header" >
            <div class="right-content clearfix">
                <div class="float-top-element">
                	 <span ><h2 class="call_now" id="v3" style="font-size:24px;text-align:center;"><?php echo "Tamil Nadu Police"; ?></h1></span>
                </div>  
				<div class="float-top-element">
                	 <span style="font-size:24px;text-align:center;"><h1 class="call_now2" id="v4"><?php echo "Senior Police Officers Petition System(SPOPS)"; ?></h1> 
                </div>
				<div class="float-top-element">
                	 <span ><h1 class="fo_si" id="v5"style="font-size:24px;text-align:center;"><?php echo "Petition Details" ?></h1> 
                </div>
            </div>
        </div>
    </div>
...
<!--    	<img src="images/download.png" onclick="download_document(<?php //echo $key['doc_id']; ?>)"/>-->
	...
	?>	
		<tr>
    	<td class="sub_heading" style="text-align:left !important;">Linking Details</td>
    ...
    <?PHP
		...
		foreach($status_rowarray as $status_row){
			...
			if($_SESSION['lang']=='T'){
				...
				$action_ent ="";
				$to_action_ent="";
				$action_ent = "<b style='vertical-align: top;'>".$status_row['dept_desig_name'].", ".$status_row['location_name']."</b>";
				if($status_row['l_to_whom']!=''){
				$action_ent.=" and sent to ";
			...
			if($status_row['l_action_type_code']=='A'||$status_row['l_action_type_code']=='R'){
				if($status_row['l_action_type_code']=='A'){
					$color='#118e11;font-weight:bolder;vertical-align: top;';
				}if($status_row['l_action_type_code']=='R'){
					$color='#bd0505;font-weight:bold;vertical-align: top;';
				}
