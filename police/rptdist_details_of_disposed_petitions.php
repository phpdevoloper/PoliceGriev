...
{ 
	...
	document.rpt_abstract.action="rptdist_details_of_disposed_petitions.php";
...
<div class="contentMainDiv" style="width:70%;margin:auto;">
	<div class="contentDiv">	
		<table class="rptTbl">
			...
			<tr> 
				<th colspan="14" class="search_desc"><?php echo $label_name[91]; ?>&nbsp;&nbsp;&nbsp;<?php echo $label_name[1]; ?> : <?php echo $p_from_date; ?> 
				&nbsp;&nbsp;&nbsp;<?php echo $label_name[2]; ?> : <?php echo $p_to_date; ?> </th>
			</tr>
...
?>
				...
				<?php if($disposed_total!=0){?>
					<a href="" onclick="return detail_view('<?php echo $p_from_date; ?>','<?php echo $p_to_date; ?>','<?php echo $dept_desig_id; ?>','<?php echo $pet_source; ?>','<?PHP echo $dept_desig_name; ?>')"> <?php echo $disposed_total;?> </a> 
				<?php } else{?>
		...
		<table class="rptTbl">
			<thead>
			 ...
			 <tr> 
                ...
                <th colspan="8" class="search_desc"><?PHP echo $label_name[91]; //Disposed Period?> &nbsp;&nbsp;&nbsp;<?PHP echo $label_name[1]." : "; //From Date?>  
